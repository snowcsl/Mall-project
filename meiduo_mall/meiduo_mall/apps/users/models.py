...
class Address(BaseModel):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='addresses',
                             verbose_name='用户')  # 当前地址属于哪个用户  通过用户外外键关联
    ...
    district = models.ForeignKey('areas.Area', on_delete=models.PROTECT, related_name='district_addresses',
                                 verbose_name='区')  # ForeignKey通过id值进行保存

    place = models.CharField(max_length=50, verbose_name='地址')  # 详情地址
