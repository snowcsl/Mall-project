...
SECRET_KEY = '__h5$^sf64x#ug#(r^clxtnano8_$u*=_+$ru1#&a3ib)utmp3'
...
DATABASES = {
    'default': {
        ...
        'PORT': 3306,  # 数据库端口
        'USER': 'meiduo11',  # 数据库用户名
        'PASSWORD': 'meiduo11',  # 数据库用户密码
        'NAME': 'meiduo_mall11'  # 数据库名字
    }
}
...
CRONJOBS = [
    # 每5分钟执行一次生成主页静态文件
    ('*/5 * * * *', 'contents.crons.generate_static_index_html', '>> /home/python/Desktop/meiduo_mall11/meiduo_mall/logs/crontab.log')
]
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://192.168.91.178:9200/',  # 此处为elasticsearch运行的服务器ip地址，端口号固定为9200
